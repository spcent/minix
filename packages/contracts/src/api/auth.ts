export const LOGIN_PLATFORMS = ["wechat", "h5"] as const;
export type LoginPlatformKind = (typeof LOGIN_PLATFORMS)[number];
export const LOGIN_METHODS = ["wechat_code", "phone_code", "password", "guest", "oauth"] as const;
export type LoginMethod = (typeof LOGIN_METHODS)[number];
export const AUTH_OAUTH_PURPOSES = ["login", "bind"] as const;
export type AuthOAuthPurpose = (typeof AUTH_OAUTH_PURPOSES)[number];
export const AUTH_IDENTITY_UPGRADE_METHODS = ["phone_code", "password"] as const;
export type AuthIdentityUpgradeMethod = (typeof AUTH_IDENTITY_UPGRADE_METHODS)[number];
...
export const AUTH_BIND_IDENTITY_WORKFLOW_KINDS = ["guest_upgrade", "phone_binding", "oauth_binding"] as const;
export type AuthBindIdentityWorkflowKind = (typeof AUTH_BIND_IDENTITY_WORKFLOW_KINDS)[number];
