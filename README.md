...
Production boundary, provider setup, capability support, and accepted deferred issues are documented in [docs/PRODUCTION_READINESS.md](docs/PRODUCTION_READINESS.md).
