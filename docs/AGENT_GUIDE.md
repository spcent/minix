...
3. scaffold placeholder host wiring with `pnpm scaffold:page <feature-name> <page-key>` when adding a new host page; when the feature was created from a scaffold template, page wiring will inherit that template's default page-data and route shape
